...
\restrict 2rWF5SfN9dBkS0Ehk4gfOz3be2v3I8ActG59sKUweTyFQaigpde8NPqdMTJ360q
...
--
-- Name: tasks_category_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tasks_category_id_index ON public.tasks USING btree (category_id);
...
--
-- Name: tasks tasks_category_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasks
    ADD CONSTRAINT tasks_category_id_foreign FOREIGN KEY (category_id) REFERENCES public.categories(id) ON DELETE SET NULL;
...
\unrestrict 2rWF5SfN9dBkS0Ehk4gfOz3be2v3I8ActG59sKUweTyFQaigpde8NPqdMTJ360q

--
-- PostgreSQL database dump
--

\restrict igUF42PYkhQqBtQcDELs6oCOmJ9Js0v9n5BKQ7Tl5S2lVmf0fZ5a3VeT9rOq7PP
...
4	2026_09_10_080300_create_categories_table	1
5	2026_09_10_080329_create_tasks_table	1
\.
...
\unrestrict igUF42PYkhQqBtQcDELs6oCOmJ9Js0v9n5BKQ7Tl5S2lVmf0fZ5a3VeT9rOq7PP
